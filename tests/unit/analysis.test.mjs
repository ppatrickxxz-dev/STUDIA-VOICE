...
test('analysis measures peak, RMS, clipping and provenance without inventing MIR fields', () => {
  const result = analyzeAudioBuffer(fakeBuffer([[0, 0.5, -1, 1]], 1000), { measuredAt: 1234, windowMs: 10 });
...
test('analysis handles stereo PCM and bounded ratios', () => {
