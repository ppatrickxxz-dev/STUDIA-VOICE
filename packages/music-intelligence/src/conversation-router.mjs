...
function describeIntent(intent) {
  if (intent.versionReference === 'prefer_previous') {
    return 'Entendi que você prefere a versão anterior. Mantive o projeto intacto e registrei isso como referência de versão para a próxima ação.';
  }
